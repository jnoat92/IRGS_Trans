...
from .unet.unet_parts import Up, DoubleConv
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        # self.up1 = Up(self.num_features*2 , self.num_features//2 , bilinear=False)
        # self.up1.conv = DoubleConv(self.num_features*3//2, self.num_features//2)
        # self.up2 = Up(self.num_features//2 , self.num_features//4 , bilinear=False)
        # self.up3 = Up(self.num_features//4 , self.num_features//8 , bilinear=False)
        # self.up4 = Up(self.num_features//8 , self.num_features//16, bilinear=False)
        # self.up4.conv = DoubleConv(self.num_features//16, self.num_features//16)
        # self.up5 = Up(self.num_features//16, self.num_features//32, bilinear=False)
        # self.up5.conv = DoubleConv(self.num_features//32, self.num_features//32)
        
        self.out_conv = nn.Conv2d(self.num_features//16, num_classes, kernel_size=1)
